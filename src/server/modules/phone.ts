...
export function EndPhoneCall(callID: string): void {
    ...
    Debug(`[Phone] Call Ended | Call ID ${callID} | Player A ${callData.playerA} | Player B ${callData.playerB}`);
...
export async function LoadModule(): Promise<void> {
    ...
    AddEventHandler('playerDropped', () => {
        ...
        const phoneCall = ActivePhoneCalls.find(call => call.playerA === serverID || call.playerB === serverID);
